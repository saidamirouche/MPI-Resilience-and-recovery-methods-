...
this plot was done by [[https://doc.ubuntu-fr.org/octave][OCTAVE]], and it shows the different behavor of the recovery methods (LI, Reset, ER) compared with the Nan-fault methode (NF) when killing 4 processes
